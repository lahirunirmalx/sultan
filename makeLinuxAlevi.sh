...
cp ../linux/alevi.desktop ${PWD}/AppDir/usr/share/applications/
cp ../linux/alevi.png ${PWD}/AppDir/usr/share/icons/
...
rm ${PWD}/AppDir/alevi.png

cp -R ${PWD}/AppDir/usr/plugins/* ${PWD}/AppDir/usr/bin/

$APPIMAGE_BUILDER --appdir ${PWD}/AppDir --recipe ../linux/AppImageBuilder_alevi_x86_64.yml 
