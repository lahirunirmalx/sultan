...
macx {
    QMAKE_LIBDIR += $$OUT_PWD/../bin/Alevi.app/Contents/Frameworks
    ...
    DESTDIR = ../bin
    copysh.commands = $$quote(cp -R $${PWD}/../script/Alevi.sh $${OUT_PWD}/../bin/)
    QMAKE_EXTRA_TARGETS += copysh
    POST_TARGETDEPS += copysh
}

RESOURCES += alevi.qrc sqlmigration.qrc translation.qrc

TRANSLATIONS = ../translation/alevi_id.ts
